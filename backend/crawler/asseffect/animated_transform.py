...
class FontSize(Affect):
    ...
    def __init__(self, config: int) -> None:
        super().__init__()
        self.effect_code = AnimatedTransform.FontAffect.FONT_SIZE.value
...
class LetterSpace(Affect):
    ...
    def __init__(self, space_param):
        self.effect_code = AnimatedTransform.FontAffect.LETTER_SPACE.value
...
class PrimaryFillColor:
    ...
    def __init__(self, colorvalue: int):
        self.effect_code = AnimatedTransform.FontAffect.PRIMARY_FILL_COLOR.value
        rgb = RGB(colorvalue)
...
class SecondaryFillColor:
    ...
    def __init__(self, colorvalue: int):
        self.effect_code = AnimatedTransform.FontAffect.SECONDARY_FILL_COLOR.value
        rgb = RGB(colorvalue)
        self.effect_param = "H{}{}{}".format(rgb.b, rgb.g, rgb.r)
        pass
...
class BorderFillColor:
    ...
    def __init__(self, colorvalue: int):
        self.effect_code = AnimatedTransform.FontAffect.BORDER_FILL_COLOR.value
        rgb = RGB(colorvalue)
        self.effect_param = "H{}{}{}".format(rgb.b, rgb.g, rgb.r)
        pass
...
class ShadowFillColor:
    ...
    def __init__(self, colorvalue: int):
        self.effect_code = AnimatedTransform.FontAffect.SHADOW_COLOR.value
        rgb = RGB(colorvalue)
        self.effect_param = "H{}{}{}".format(rgb.b, rgb.g, rgb.r)
        pass
...
class PrimaryFillAlpha(Affect):
    ...
    def __init__(self, alphavalue: int):
        self.effect_code = AnimatedTransform.FontAffect.PRIMARY_FILL_ALPHA.value
...
class SecondaryFillAlpha(Affect):
    ...
    def __init__(self, alphavalue: int):
        self.effect_code = AnimatedTransform.FontAffect.SECONDARY_FILL_ALPHA.value
        alpha = hex(alphavalue)[2:4]
        self.effect_param = "H{}".format(alpha)
        pass
...
class BorderFillAlpha(Affect):
    ...
    def __init__(self, alphavalue: int):
        self.effect_code = AnimatedTransform.FontAffect.BORDER_FILL_ALPHA.value
        alpha = hex(alphavalue)[2:4]
        self.effect_param = "H{}".format(alpha)
        pass
...
class ShadowFillAlpha(Affect):
    ...
    def __init__(self, alphavalue: int):
        self.effect_code = AnimatedTransform.FontAffect.SHADOWN_ALPHA.value
        alpha = hex(alphavalue)[2:4]
        self.effect_param = "H{}".format(alpha)
        pass
...
class Border(Affect):
    ...
    def set_border_code_style(self):
        self.effect_code = AnimatedTransform.OtherAffect.TEXT_BORDER_WIDTH.value
...
class BorderX(Border):
    ...
    def set_border_code_style(self):
        self.effect_code = AnimatedTransform.OtherAffect.TEXT_BORDER_WIDTH_X.value


class BorderY(Border):

    def set_border_code_style(self):
        self.effect_code = AnimatedTransform.OtherAffect.TEXT_BORDER_WIDTH_Y
...
class ShadowDistance(Affect):
    ...
    def set_border_code_style(self):
        self.effect_code = AnimatedTransform.OtherAffect.TEXT_SHADOW_WIDTH.value
...
class ShadowDistanceX(ShadowDistance):
    ...
    def set_border_code_style(self):
        self.effect_code = AnimatedTransform.OtherAffect.TEXT_SHADOW_WIDTH_X.value


class ShadowDistanceY(ShadowDistance):

    def set_border_code_style(self):
        self.effect_code = AnimatedTransform.OtherAffect.TEXT_SHADOW_WIDTH_Y
...
class RectangleClip(Affect):
    ...
    def __init__(self, x1, y1, x2, y2):
        self.effect_code = AnimatedTransform.OtherAffect.TEXT_CLIP.value
...
class BlurEdges(Affect):
    ...
    def __init__(self, strength):
        self.effect_code = AnimatedTransform.OtherAffect.TEXT_BLUR_EDGES.value
...
class BlurEdgesGaussian(Affect):
    ...
    def __init__(self, strength):
        self.effect_code = AnimatedTransform.OtherAffect.TEXT_BLUR_EDGES_GAUSSIAN.value
        self.paramter = '{}'.format(strength)
